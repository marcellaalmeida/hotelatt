    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Reservas</h2>
                    <a href="create.php" class="btn btn-primary mb-3">Nova Reserva</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $reserva) : ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge 
                                        <?= $reserva->getStatus() == 'Confirmada' ? 'bg-primary' : '' ?>
                                        <?= $reserva->getStatus() == 'Check-in' ? 'bg-success' : '' ?>
                                        <?= $reserva->getStatus() == 'Check-out' ? 'bg-secondary' : '' ?>
                                        <?= $reserva->getStatus() == 'Cancelada' ? 'bg-danger' : '' ?>">
                                        <?= $reserva->getStatus() ?>
                                    </span>
                                </td>
                                <td>R$ <?= number_format($reserva->getValorTotal(), 2, ',', '.') ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $reserva->getIdReserva() ?>" title="Editar" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="btn btn-sm btn-outline-danger" href="destroy.php?id=<?= $reserva->getIdReserva() ?>" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir esta reserva?')">
