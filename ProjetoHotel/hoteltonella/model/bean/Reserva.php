...
class Reserva {
    ...
    // Método para calcular número de diárias
    ...
    // Método para verificar se reserva está ativa
    public function isAtiva() {
        return $this->status === 'Ativa' || $this->status === 'Confirmada';
    }

    // Método para retornar uma string do objeto
    public function __toString() {
        return "Reserva #" . $this->id_reserva . " - " . $this->hospede . " (" . $this->status . ")";
    }
}
?>