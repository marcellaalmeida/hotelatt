<?php
    // Buscar as informações da reserva para atualizar
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark"> <a
            class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Hotel Management</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="form-group">
                                    ...
                                    <input type="date" name="data_checkin" class="form-control" value="<?= $reserva->getDataCheckin() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="data_checkout">Data de Check-out</label>
                                    <input type="date" name="data_checkout" class="form-control" value="<?= $reserva->getDataCheckout() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="quarto">Número do Quarto</label>
                                    <input type="number" name="quarto" class="form-control" value="<?= $reserva->getQuarto() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="hospede">Nome do Hóspede</label>
                                    <input type="text" name="hospede" class="form-control" value="<?= $reserva->getHospede() ?>" required>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="form-group">
                                    <label for="funcionario">Funcionário Responsável</label>
                                    <input type="text" name="funcionario" class="form-control" value="<?= $reserva->getFuncionario() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="status">Status</label>
                                    <select name="status" class="form-control" required>
                                        <option value="Confirmada" <?= $reserva->getStatus() == 'Confirmada' ? 'selected' : '' ?>>Confirmada</option>
                                        <option value="Check-in" <?= $reserva->getStatus() == 'Check-in' ? 'selected' : '' ?>>Check-in</option>
                                        <option value="Check-out" <?= $reserva->getStatus() == 'Check-out' ? 'selected' : '' ?>>Check-out</option>
                                        <option value="Cancelada" <?= $reserva->getStatus() == 'Cancelada' ? 'selected' : '' ?>>Cancelada</option>
                                    </select>
                                </p>
                                <p class="form-group">
                                    <label for="valor_total">Valor Total</label>
                                    <input type="number" step="0.01" name="valor_total" class="form-control" value="<?= $reserva->getValorTotal() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="funcionario_id_funcionario">ID do Funcionário</label>
                                    <input type="number" name="funcionario_id_funcionario" class="form-control" value="<?= $reserva->getFuncionarioIdFuncionario() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="hospede_id_hospede">ID do Hóspede</label>
                                    <input type="number" name="hospede_id_hospede" class="form-control" value="<?= $reserva->getHospedeIdHospede() ?>" required>
                                </p>
                                <p class="form-group">
                                    <label for="quarto_idquarto">ID do Quarto</label>
                                    <input type="number" name="quarto_idquarto" class="form-control" value="<?= $reserva->getQuartoIdquarto() ?>" required>
                                </p>
                            </div>
                        </div>
