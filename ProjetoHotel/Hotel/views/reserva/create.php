                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="form-group">
                                    ...
                                    <input type="number" name="quarto" class="form-control" required>
                                </p>
                                <p class="form-group">
                                    <label for="hospede">Nome do Hóspede</label>
                                    <input type="text" name="hospede" class="form-control" required>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="form-group">
                                ...
                                <p class="form-group">
                                    ...
                                    <input type="number" name="funcionario_id_funcionario" class="form-control" required>
                                </p>
                                <p class="form-group">
                                    <label for="hospede_id_hospede">ID do Hóspede</label>
                                    <input type="number" name="hospede_id_hospede" class="form-control" required>
                                </p>
                                <p class="form-group">
                                    <label for="quarto_idquarto">ID do Quarto</label>
                                    <input type="number" name="quarto_idquarto" class="form-control" required>
                                </p>
                            </div>
                        </div>
                        <p class="form-group mt-3">
                            <input type="reset" value="Limpar" class="btn btn-default">
                            <input type="submit" value="Salvar Reserva" class="btn btn-primary">
                        </p>
                    </form>
                </div>
            </main>
