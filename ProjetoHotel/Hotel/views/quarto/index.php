...
<head>
    ...
    <title>Sistema Hotel - Quartos</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Quartos</h2>
                    <a href="create.php" class="btn btn-primary mb-3">Novo Quarto</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $quarto) : ?>
                            <tr>
                                ...
                                <td>R$ <?= number_format($quarto->getPreco(), 2, ',', '.') ?></td>
                                <td>
                                    <span class="badge 
                                        <?= $quarto->getStatus() == 'Disponível' ? 'bg-success' : '' ?>
                                        <?= $quarto->getStatus() == 'Ocupado' ? 'bg-danger' : '' ?>
                                        <?= $quarto->getStatus() == 'Manutenção' ? 'bg-warning' : '' ?>
                                        <?= $quarto->getStatus() == 'Reservado' ? 'bg-info' : '' ?>">
                                        <?= $quarto->getStatus() ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="edit.php?id=<?= $quarto->getIdquarto() ?>" title="Editar" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="btn btn-sm btn-outline-danger" href="destroy.php?id=<?= $quarto->getIdquarto() ?>" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir este quarto?')">
